      ...
      <View style={styles.container}>
        ...
        <View>
          <View style={styles.imagesContainer}>
            ...
            <Image
              ...
              source={{
                uri: 'https://i2.wp.com/hipertextual.com/wp-content/uploads/2020/04/hipertextual-mas-facil-durante-cuarentena-google-maps-muestra-que-restaurantes-envian-domicilio-2020815281.jpg?w=1500&ssl=1',
              }}
            />
          </View>
        </View>
        <View style={styles.formShadow}>
          ...
          <TouchableOpacity
            ...
            <Text style={styles.buttonDarkText}>Click here to delete passenger</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
